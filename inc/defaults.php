...
function liferuss_default_options() {
	$core = array(
		...
		'float_widget_enabled'   => '1',
		'float_widget_title'     => 'پاسخگوی شما هستیم',
		'float_widget_subtitle'  => 'یکی از راه‌های زیر را برای ارتباط انتخاب کنید',
		'float_widget_offset_x'  => '16',
		'float_widget_offset_y'  => '16',
		'float_channels'         => array(
			array( 'enabled' => '1', 'type' => 'phone', 'label' => 'تماس با مشاور', 'url' => '', 'icon' => 'phone' ),
			array( 'enabled' => '1', 'type' => 'whatsapp', 'label' => 'ارتباط از طریق واتساپ', 'url' => '', 'icon' => 'whatsapp' ),
			array( 'enabled' => '1', 'type' => 'telegram', 'label' => 'ارتباط از طریق تلگرام', 'url' => '', 'icon' => 'telegram' ),
			array( 'enabled' => '1', 'type' => 'instagram', 'label' => 'پیج اینستاگرام', 'url' => '', 'icon' => 'instagram' ),
			array( 'enabled' => '1', 'type' => 'consult', 'label' => 'مشاوره رایگان', 'url' => '#consultation', 'icon' => 'chat' ),
			array( 'enabled' => '0', 'type' => 'custom', 'label' => '', 'url' => '', 'icon' => 'chat' ),
			array( 'enabled' => '0', 'type' => 'custom', 'label' => '', 'url' => '', 'icon' => 'chat' ),
		),
		'bottom_nav_enabled'     => '1',
		'bottom_nav_items'       => array(
			array( 'enabled' => '1', 'label' => 'خانه', 'url' => '/', 'icon' => 'home', 'primary' => '0' ),
			array( 'enabled' => '1', 'label' => 'خدمات', 'url' => '/services/', 'icon' => 'cap', 'primary' => '0' ),
			array( 'enabled' => '1', 'label' => 'دانشگاه‌ها', 'url' => '/universities/', 'icon' => 'building', 'primary' => '0' ),
			array( 'enabled' => '1', 'label' => 'تماس', 'url' => '/contact/', 'icon' => 'phone', 'primary' => '0' ),
			array( 'enabled' => '1', 'label' => 'مشاوره', 'url' => '#consultation', 'icon' => 'chat', 'primary' => '1' ),
			array( 'enabled' => '0', 'label' => '', 'url' => '', 'icon' => 'info', 'primary' => '0' ),
		),
